...
class RandomApartmentGeneratorTest {
    ...
    class GeneratorDefaultParamsTests {
        ...
        @RepeatedTest(10)
        void generateTest_should_GenerateCorrectApartment_When_DefaultMinAreaMinPrice() {
            double minArea = 30.0;
            ...
            BigDecimal minPrice = new BigDecimal(apartment.getArea()).multiply(minPricePerSquareMeter);
